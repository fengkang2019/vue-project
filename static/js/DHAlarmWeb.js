...
DHAlarmWeb.prototype.login = function(uname,pwd,ipAddr) {
	...
	this.alarmUrl = "wss://"+ ipAddr +":8088/ws";
	this.webrtcUrl = "wss://"+ ipAddr +":8089/ws";
	this.uname = uname;
	this.pwd = pwd;
	
	if(sessionStorage.getItem('alarmUrl') != this.alarmUrl || !this.alarmSocketOpened){
		this.openAlarmSocket();
	}
...
DHAlarmWeb.prototype.openAudio = function(loginHandle,deviceId, isTalk) {
	...
	this.audioWs[deviceId] = new WebSocket("wss://"+sessionStorage.getItem('serverAddr')+":8088/ws");
...
DHAlarmWeb.prototype.openDeviceAudio = function(loginHandle,deviceId) {
	this.loginHandle = loginHandle;
	this.deviceId = deviceId;
	this.deviceAudioWs[deviceId] = new WebSocket("wss://"+sessionStorage.getItem('serverAddr')+":8088/ws");
